...
## Description
Unleash your inner detective to solve a crime! Analyze the crime scene and use your programming skills to decrypt hidden messages. Each piece of encrypted evidence will lead you closer to the truth. Combine the clues with your detective skills to identify the culprit. Are you ready to crack the code and solve the mystery?

## How the Event Works
- The game consists of a single level.
- The event comprises multiple coding problems, each solution serving as a hint to solve the crime.
